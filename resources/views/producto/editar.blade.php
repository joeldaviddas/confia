            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-danger me-md-2 text-white" href="{{route('productos.index')}}" role="button">Cancelar</a>
                    </div>
                    <h4 class="card-title">Editar producto: {{$producto->nombre}}</h4>
                </div>
                <form class="form-horizontal" action="{{ route('productos.update', $producto) }}"  method="POST">
                    @csrf @method('put')
                    <div class="card-body">
