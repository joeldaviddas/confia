...
<div class="row">
    <div class="card-header">
        <div class="d-md-flex justify-content-md-end">
            <a class="btn btn-info" href="{{route('productos.create')}}" role="button">Nuevo Registro</a>
        </div>
                        ...
                        <div class="container text-center">
                            <div class="row justify-content-md-end">
                                <div class="col col-lg-2">
                                    <a class="btn btn-sm btn-outline" href="{{route('productos.edit', $data->id)}}"><i class=" fas fa-pencil-alt" style="color:blue; font-size:1.5rem"></i></a>
                                </div>

                                <div class="col col-lg-2">
                                    <a class="btn btn-sm btn-outline" href="#" data-bs-toggle="modal" data-bs-target="#modal-producto" data-nombre="{{ $data->nombre }}" role="button" id="botonmodal"><i class=" fas fa-eye" style="color:darkgoldenrod; font-size:1.5rem"></i></a>
                                </div>
