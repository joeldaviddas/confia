...
<div class="row">
    <div class="card-header">
        <div class="d-md-flex justify-content-md-end">
            <a class="btn btn-info" href="{{route('movimientos.create')}}" role="button">Nuevo Registro</a>
        </div>
                                ...
                                <div class="container text-center">
                                    <div class="row justify-content-md-end">
                                        <div class="col col-lg-1">
                                            <a class="btn btn-sm btn-outline" href="{{route('movimientos.edit', $data->id)}}"><i class=" fas fa-pencil-alt" style="color:blue; font-size:1.5rem"></i></a>
                                        </div>

                                    <div class="col col-lg-1">
                                        <form action="{{ route('movimientos.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
