...
<div class="row">
    <div class="card-header">
        <div class="d-md-flex justify-content-md-end">
            <a class="btn btn-info" href="{{route('personas.create')}}" role="button">Nuevo Registro</a>
        </div>
                                ...
                                <div class="container text-center">
                                    <div class="row justify-content-m">
                                        <div class="col col-lg-2">
                                            <a class="btn btn-sm btn-outline" href="{{route('personas.edit', $data->id)}}"><i class=" fas fa-pencil-alt" style="color:blue; font-size:1.5rem"></i></a>
                                        </div>
                                    ...
                                    <div class="col col-lg-2">
                                        <form action="{{ route('personas.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
