            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-danger me-md-2 text-white" href="{{route('personas.index')}}" role="button">Cancelar</a>
                    </div>
                    <h4 class="card-title">Editar persona: {{$persona->nombre}}</h4>
                </div>
                <form class="form-horizontal" action="{{ route('personas.update', $persona) }}"  method="POST">
                    @csrf @method('put')
                    <div class="card-body">
